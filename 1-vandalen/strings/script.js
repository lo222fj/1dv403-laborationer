	...
	var convertString = function(str) {
			...
			for (var index = 0; index < str.length; index++) {
				...
				if (str[index] == "a" || str[index] == "A") {
					answer[index] = "#";
				} else if (str[index] == str[index].toUpperCase(str[index])) {
					answer[index] = str[index].toLowerCase(str[index]);
				} else if (str[index] == str[index].toLowerCase(str[index])) {
					answer[index] = str[index].toUpperCase(str[index]);
				}
